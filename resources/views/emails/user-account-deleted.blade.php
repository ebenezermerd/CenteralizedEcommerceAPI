    ...
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                ...
                <p>Your account on the Korecha platform has been removed.</p>
            </div>

            <div class="alert-box">
                <strong>Important Notice:</strong>
                <p>This action is permanent and cannot be undone. All your data has been removed from our system.</p>
            </div>
            ...
            <div class="footer">
                <p>Thank you for being part of Korecha.</p>
