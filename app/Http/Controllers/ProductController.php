    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validated = Validator::make($request->all(), [
                ...
                'quantity_threshold' => 'nullable|integer|min:1',
                'additional_cost_type' => 'nullable|in:percentage,fixed',
                'additional_cost_percentage' => 'nullable|numeric|min:0|max:100|required_if:additional_cost_type,percentage',
                'additional_cost_fixed' => 'nullable|numeric|min:0|required_if:additional_cost_type,fixed',
                'price' => 'required|numeric|min:1',
                'priceSale' => 'nullable|numeric|min:0',
                'taxes' => 'nullable|numeric|min:0',
                'colors' => 'nullable|array|min:0',
                'sizes' => 'nullable|array|min:0',
                'gender' => 'nullable|array|min:0',
